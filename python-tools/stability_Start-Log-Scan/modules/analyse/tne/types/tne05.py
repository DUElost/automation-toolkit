...
# Embedded file name: modules\analyse\tne\types\tne05.py
import os
...
class Tne05(TneBase):
    ...
    def __init__(self, path):
        super(Tne05, self).__init__(path)
        self._exp_class = "0xffffff05_JE"
        self._exp_type = "0xffffff05_JE"
...
# okay decompiling extracted_pyz_modules\modules\analyse\tne\types\tne05.pyc
