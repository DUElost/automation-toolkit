...
# Embedded file name: modules\analyse\tne\types\tne0a.py
import os
...
class Tne0a(TneBase):
    ...
    def __init__(self, path):
        super(Tne0a, self).__init__(path)
        self._exp_class = "0xffffff0a_NE"
        self._exp_type = "0xffffff0a_NE"
...
# okay decompiling extracted_pyz_modules\modules\analyse\tne\types\tne0a.pyc
