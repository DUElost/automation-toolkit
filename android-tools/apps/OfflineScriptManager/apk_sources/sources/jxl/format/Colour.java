...
public class Colour {
    ...
    public static final Colour WHITE = new Colour(9, "white", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    public static final Colour DEFAULT_BACKGROUND1 = new Colour(0, "default background", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    public static final Colour DEFAULT_BACKGROUND = new Colour(192, "default background", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    public static final Colour PALETTE_BLACK = new Colour(8, "black", 1, 0, 0);
    public static final Colour RED = new Colour(10, "red", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0, 0);
    public static final Colour BRIGHT_GREEN = new Colour(11, "bright green", 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0);
    public static final Colour BLUE = new Colour(12, "blue", 0, 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    public static final Colour YELLOW = new Colour(13, "yellow", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0);
    public static final Colour PINK = new Colour(14, "pink", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    public static final Colour TURQUOISE = new Colour(15, "turquoise", 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
    ...
    static {
        ...
        PERIWINKLE = new Colour(24, "periwinkle%", 153, 153, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        PLUM2 = new Colour(25, "plum", 153, 51, 102);
        IVORY = new Colour(26, "ivory", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 204);
        LIGHT_TURQUOISE2 = new Colour(27, "light turquoise", 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        DARK_PURPLE = new Colour(28, "dark purple", 102, 0, 102);
        CORAL = new Colour(29, "coral", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 128, 128);
        OCEAN_BLUE = new Colour(30, "ocean blue", 0, 102, 204);
        ICE_BLUE = new Colour(31, "ice blue", 204, 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        DARK_BLUE2 = new Colour(32, "dark blue", 0, 0, 128);
        PINK2 = new Colour(33, "pink", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        YELLOW2 = new Colour(34, "yellow", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 0);
        TURQOISE2 = new Colour(35, "turqoise", 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        VIOLET2 = new Colour(36, "violet", 128, 0, 128);
        DARK_RED2 = new Colour(37, "dark red", 128, 0, 0);
        TEAL2 = new Colour(38, "teal", 0, 128, 128);
        BLUE2 = new Colour(39, "blue", 0, 0, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        SKY_BLUE = new Colour(40, "sky blue", 0, 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        LIGHT_TURQUOISE = new Colour(41, "light turquoise", 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        LIGHT_GREEN = new Colour(42, "light green", 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 204);
        VERY_LIGHT_YELLOW = new Colour(43, "very light yellow", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 153);
        PALE_BLUE = new Colour(44, "pale blue", 153, 204, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        ROSE = new Colour(45, "rose", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 153, 204);
        LAVENDER = new Colour(46, "lavender", 204, 153, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        TAN = new Colour(47, "tan", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 204, 153);
        LIGHT_BLUE = new Colour(48, "light blue", 51, 102, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        AQUA = new Colour(49, "aqua", 51, 204, 204);
        LIME = new Colour(50, "lime", 153, 204, 0);
        GOLD = new Colour(51, "gold", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 204, 0);
        LIGHT_ORANGE = new Colour(52, "light orange", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 153, 0);
        ORANGE = new Colour(53, "orange", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, 102, 0);
        ...
        AUTOMATIC = new Colour(64, "automatic", SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT, SheetSettings.DEFAULT_DEFAULT_ROW_HEIGHT);
        GRAY_80 = colour3;
        GRAY_50 = colour2;
        GRAY_25 = colour;
    }
