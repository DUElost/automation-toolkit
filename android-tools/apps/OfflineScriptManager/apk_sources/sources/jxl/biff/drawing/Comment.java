...
public class Comment implements DrawingGroupObject {
    ...
    public String getText() {
        if (this.commentText == null) {
            ...
            this.commentText = data[0] == 0 ? StringHelper.getString(data, data.length - 1, 1, this.workbookSettings) : StringHelper.getUnicodeString(data, (data.length - 1) / 2, 1);
        }
    ...
    public void writeTailRecords(File file) {
        file.write(this.origin == Origin.READ ? this.note : new NoteRecord(this.column, this.row, this.objectId));
    }
}
