                    ...
                    for (int i3 = 0; i3 < row.length; i3++) {
                        if (row[i3].getType() != CellType.EMPTY || row[i3].getCellFormat() != null) {
                            ...
                            if (row[i3].getCellFormat() != null) {
                                ...
                                BorderLineStyle border2 = cellFormat.getBorder(border);
                                BorderLineStyle borderLineStyle = BorderLineStyle.NONE;
                                if (border2 != borderLineStyle || cellFormat.getBorder(Border.BOTTOM) != borderLineStyle || cellFormat.getBorder(Border.LEFT) != borderLineStyle || cellFormat.getBorder(Border.RIGHT) != borderLineStyle) {
                                    StringBuffer stringBuffer18 = new StringBuffer();
                                    stringBuffer18.append("          <border top=\"");
                                    stringBuffer18.append(cellFormat.getBorder(border).getDescription());
                                ...
                                if (!cellFormat.getFormat().getFormatString().equals(BuildConfig.FLAVOR)) {
