...
public class SortRecord extends RecordData {
    ...
    public SortRecord(Record record) {
        ...
        byte b2 = data[0];
        this.optionFlags = b2;
        this.sortColumns = (b2 & 1) != 0;
        this.sortKey1Desc = (b2 & 2) != 0;
        this.sortKey2Desc = (b2 & 4) != 0;
        this.sortKey3Desc = (b2 & 8) != 0;
        this.sortCaseSensitive = (b2 & 16) != 0;
        byte b3 = data[2];
        this.col1Size = b3;
        ...
        if (data[5] == 0) {
            ...
            this.col1Name = StringHelper.getUnicodeString(data, b3, 6);
            i = this.col1Size * 2;
        }
        int i2 = 6 + i;
        ...
        if (i3 > 0) {
            ...
            this.col2Name = BuildConfig.FLAVOR;
        }
        int i5 = this.col3Size;
        if (i5 <= 0) {
            this.col3Name = BuildConfig.FLAVOR;
            return;
        }
        int i6 = i2 + 1;
        if (data[i2] == 0) {
