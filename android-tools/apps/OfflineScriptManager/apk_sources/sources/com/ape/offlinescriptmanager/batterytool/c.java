...
public class c extends Fragment {
    ...
    private List<com.ape.offlinescriptmanager.batterytool.f.d> c0;
    private Cursor d0;
    private Context e0;
    private e f0;
    private CursorLoader g0;
    private Looper h0;
    private HandlerC0069c i0;
    private ContentObserver j0 = new b(new Handler());
    ...
    /* renamed from: com.ape.offlinescriptmanager.batterytool.c$c  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    private final class HandlerC0069c extends Handler {
    ...
    private org.achartengine.h.d o1() {
        ...
        g.F(b2, D(R.string.voltage_chart_title), D(R.string.x_title), D(R.string.voltage_y_title), 0.0d, 0.0d, 3.2d, 4.4d, -16777216, -16777216);
        return b2;
    }

    private void p1() {
        if (f() != null) {
            CursorLoader cursorLoader = new CursorLoader(f(), h.f1984a, h.f1985b, null, null, "time ASC");
    ...
    public void q1() {
        try {
            ...
            if (cursor != null) {
                this.c0 = this.f0.f(cursor);
                this.a0.e(this.Z);
                this.Z.b();
                for (int i = 0; i < this.c0.size(); i++) {
                    this.Z.a(Long.parseLong(this.c0.get(i).b()), Float.parseFloat(this.c0.get(i).c()));
                }
                this.a0.a(this.Z);
    ...
    public void Y(Bundle bundle) {
        ...
        this.e0 = f;
        this.f0 = new e();
        f.getContentResolver().registerContentObserver(h.f1984a, true, this.j0);
        HandlerThread handlerThread = new HandlerThread("voltage", 0);
        handlerThread.start();
        this.h0 = handlerThread.getLooper();
        this.i0 = new HandlerC0069c(this.h0);
    }

    @Override // androidx.fragment.app.Fragment
    public View c0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.voltage_chart_layout, (ViewGroup) null, false);
        this.Z = new org.achartengine.g.c("Voltage Line");
        d dVar = new d();
        this.a0 = dVar;
        dVar.a(this.Z);
        this.b0 = org.achartengine.a.b(this.e0, this.a0, o1(), "H:mm");
        q1();
        ((LinearLayout) inflate.findViewById(R.id.voltage_linear_chart)).addView(this.b0, new ViewGroup.LayoutParams(-1, -1));
        return inflate;
    }
