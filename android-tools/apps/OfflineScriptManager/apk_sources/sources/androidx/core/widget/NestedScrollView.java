...
public class NestedScrollView extends FrameLayout implements l, a.f.l.i {
    ...
    private final Rect f894c;

    /* renamed from: d  reason: collision with root package name */
    private OverScroller f895d;
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f896b + "}";
        }
    ...
    static class a extends a.f.l.a {
        ...
        public void d(View view, AccessibilityEvent accessibilityEvent) {
            ...
            a.f.l.a0.e.a(accessibilityEvent, nestedScrollView.getScrollX());
            a.f.l.a0.e.b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
    ...
    private boolean B(View view, int i, int i2) {
        view.getDrawingRect(this.f894c);
        offsetDescendantRectToMyCoords(view, this.f894c);
        return this.f894c.bottom + i >= getScrollY() && this.f894c.top - i <= getScrollY() + i2;
    }
    ...
    private boolean I(Rect rect, boolean z) {
        int e = e(rect);
        boolean z2 = e != 0;
        if (z2) {
            if (z) {
    ...
    private void x() {
        this.f895d = new OverScroller(getContext());
        setFocusable(true);
    ...
    boolean D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        if (z3 && !u(1)) {
            this.f895d.springBack(i9, i11, 0, 0, 0, getScrollRange());
        }
    ...
    public boolean E(int i) {
        ...
        int height = getHeight();
        if (z) {
            this.f894c.top = getScrollY() + height;
            int childCount = getChildCount();
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
                int bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
                Rect rect = this.f894c;
            ...
            this.f894c.top = getScrollY() - height;
            Rect rect2 = this.f894c;
            if (rect2.top < 0) {
                rect2.top = 0;
            }
        }
        Rect rect3 = this.f894c;
        int i2 = rect3.top;
        int i3 = height + i2;
        rect3.bottom = i3;
        return G(i, i2, i3);
    ...
    public final void J(int i, int i2) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.f893b > 250) {
            View childAt = getChildAt(0);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
            ...
            int scrollY = getScrollY();
            this.v = getScrollY();
            OverScroller overScroller = this.f895d;
            int scrollX = getScrollX();
            overScroller.startScroll(scrollX, scrollY, 0, Math.max(0, Math.min(i2 + scrollY, Math.max(0, height - height2))) - scrollY);
            r.K(this);
        } else {
            if (!this.f895d.isFinished()) {
                this.f895d.abortAnimation();
            }
            scrollBy(i, i2);
        }
        this.f893b = AnimationUtils.currentAnimationTimeMillis();
    }

    public final void K(int i, int i2) {
        J(i - getScrollX(), i2 - getScrollY());
    }

    public boolean L(int i, int i2) {
        return this.y.n(i, i2);
    }
    ...
    public boolean b(int i) {
        ...
        if (findNextFocus == null || !B(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f894c);
            offsetDescendantRectToMyCoords(findNextFocus, this.f894c);
            k(e(this.f894c));
    ...
    public void computeScroll() {
        ...
        this.f895d.getCurrX();
        int currY = this.f895d.getCurrY();
        int i = currY - this.v;
        if (f(0, i, this.t, null, 1)) {
            i -= this.t[1];
        }
        int i2 = i;
        if (i2 != 0) {
            ...
            int scrollY = getScrollY();
            D(0, i2, getScrollX(), scrollY, 0, scrollRange, 0, 0, false);
            int scrollY2 = getScrollY() - scrollY;
            if (!g(0, scrollY2, 0, i2 - scrollY2, null, 1)) {
                int overScrollMode = getOverScrollMode();
                if (overScrollMode == 0 || (overScrollMode == 1 && scrollRange > 0)) {
                    ...
                    edgeEffect.onAbsorb((int) this.f895d.getCurrVelocity());
                }
            }
        }
        this.v = currY;
    ...
    public boolean g(int i, int i2, int i3, int i4, int[] iArr, int i5) {
        return this.y.f(i, i2, i3, i4, iArr, i5);
    }
    ...
    public void m(View view, int i, int i2, int i3, int i4, int i5) {
        ...
        scrollBy(0, i4);
        int scrollY2 = getScrollY() - scrollY;
        g(0, scrollY2, 0, i4 - scrollY2, null, i5);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i != 0) {
            ...
            this.r = -1;
            F();
            if (this.f895d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                r.K(this);
            }
            a(0);
        } else {
            ...
            if (v((int) motionEvent.getX(), y2)) {
                ...
                w();
                this.l.addMovement(motionEvent);
                this.f895d.computeScrollOffset();
                this.k = !this.f895d.isFinished();
                L(2, 0);
            } else {
                this.k = false;
                F();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.i) {
            if (this.w != null) {
                scrollTo(getScrollX(), this.w.f896b);
                this.w = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        findFocus.getDrawingRect(this.f894c);
        offsetDescendantRectToMyCoords(findFocus, this.f894c);
        k(e(this.f894c));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0073, code lost:
        if (r23.f895d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L29;
     */
    ...
    */
    ...
    public void r(int i) {
        if (getChildCount() > 0) {
            L(2, 1);
            this.f895d.fling(getScrollX(), getScrollY(), 0, i, 0, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            this.v = getScrollY();
            r.K(this);
        }
    }
    ...
    public boolean t(int i) {
        ...
        if (z && (childCount = getChildCount()) > 0) {
            View childAt = getChildAt(childCount - 1);
            this.f894c.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
            Rect rect2 = this.f894c;
            rect2.top = rect2.bottom - height;
        }
        Rect rect3 = this.f894c;
        return G(i, rect3.top, rect3.bottom);
    }
