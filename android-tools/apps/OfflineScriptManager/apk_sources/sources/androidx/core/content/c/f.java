...
public final class f {
    ...
    public static abstract class a {
        ...
        public class RunnableC0032a implements Runnable {
            ...
            final /* synthetic */ Typeface f874b;

            RunnableC0032a(Typeface typeface) {
                this.f874b = typeface;
            }
    ...
    */
    private static android.graphics.Typeface d(android.content.Context r15, android.content.res.Resources r16, android.util.TypedValue r17, int r18, int r19, androidx.core.content.c.f.a r20, android.os.Handler r21, boolean r22) {
        ...
        L25:
            return r13
        L26:
            android.graphics.Typeface r1 = a.f.e.c.e(r0, r4, r5)
            if (r1 == 0) goto L32
            if (r9 == 0) goto L31
            r9.b(r1, r10)
        L31:
            return r1
        L32:
            java.lang.String r1 = r12.toLowerCase()     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            if (r1 == 0) goto L65
            android.content.res.XmlResourceParser r1 = r0.getXml(r4)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            androidx.core.content.c.c$a r2 = androidx.core.content.c.c.b(r1, r0)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            if (r2 != 0) goto L53
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r11, r0)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            if (r9 == 0) goto L52
            r9.a(r14, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
        L52:
            return r13
        L53:
            r1 = r15
            ...
            r7 = r21
            r8 = r22
            android.graphics.Typeface r0 = a.f.e.c.b(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            return r0
        L65:
            r1 = r15
            android.graphics.Typeface r0 = a.f.e.c.c(r15, r0, r4, r12, r5)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            if (r9 == 0) goto L75
            if (r0 == 0) goto L72
            r9.b(r0, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
            goto L75
        L72:
            r9.a(r14, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.a -> L7f
        L75:
