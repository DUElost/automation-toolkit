...
public class a implements a.f.f.a.b {
    ...
    public a.f.f.a.b d(int i) {
        throw new UnsupportedOperationException();
    }

    public a.f.f.a.b e(View view) {
        throw new UnsupportedOperationException();
    }
    ...
    public CharSequence getTitleCondensed() {
        ...
        return charSequence != null ? charSequence : this.f530d;
    }
    ...
    public MenuItem setTitle(int i) {
        this.f530d = this.l.getResources().getString(i);
        return this;
    }
