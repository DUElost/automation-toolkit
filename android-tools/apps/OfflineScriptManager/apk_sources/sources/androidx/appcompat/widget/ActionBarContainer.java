...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        a.f.l.r.Q(this, new b(this));
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.a.j.ActionBar);
        this.f = obtainStyledAttributes.getDrawable(a.a.j.ActionBar_background);
    ...
    public void onFinishInflate() {
        ...
        this.f587d = findViewById(a.a.f.action_bar);
        this.e = findViewById(a.a.f.action_context_bar);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return this.f585b || super.onInterceptTouchEvent(motionEvent);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.i) {
            ...
            if (this.f != null) {
                if (this.f587d.getVisibility() == 0) {
                    drawable2 = this.f;
                    left = this.f587d.getLeft();
                    top = this.f587d.getTop();
                    right = this.f587d.getRight();
                    view = this.f587d;
                } else {
                    View view3 = this.e;
    ...
    */
    public void onMeasure(int r4, int r5) {
        ...
        L1c:
            ...
            android.view.View r4 = r3.f587d
            if (r4 != 0) goto L24
            return
        L24:
            int r4 = android.view.View.MeasureSpec.getMode(r5)
            android.view.View r0 = r3.f586c
            if (r0 == 0) goto L6f
    ...
    public void setPrimaryBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            View view = this.f587d;
            if (view != null) {
                this.f.setBounds(view.getLeft(), this.f587d.getTop(), this.f587d.getRight(), this.f587d.getBottom());
            }
        }
        boolean z = true;
        if (!this.i ? this.f != null || this.g != null : this.h != null) {
    ...
    public void setStackedBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            if (this.j && (drawable2 = this.g) != null) {
                drawable2.setBounds(this.f586c.getLeft(), this.f586c.getTop(), this.f586c.getRight(), this.f586c.getBottom());
            }
        }
        boolean z = true;
        if (!this.i ? this.f != null || this.g != null : this.h != null) {
