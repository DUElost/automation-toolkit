...
.method constructor <init>(La/n/a/a/h$h;)V
    .locals 2
    ...
    iget-object v1, p1, La/n/a/a/h$h;->c:Landroid/content/res/ColorStateList;

    iget-object p1, p1, La/n/a/a/h$h;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v1, p1}, La/n/a/a/h;->j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public static b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)La/n/a/a/h;
    .locals 6
    ...
    invoke-static {p0, p1, v2, p2}, La/n/a/a/h;->c(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)La/n/a/a/h;
...
.method public static c(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)La/n/a/a/h;
    .locals 1
...
.method private e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v1, v0, La/n/a/a/h$h;->b:La/n/a/a/h$g;

    new-instance v2, Ljava/util/ArrayDeque;

    invoke-direct {v2}, Ljava/util/ArrayDeque;-><init>()V

    iget-object v3, v1, La/n/a/a/h$g;->h:La/n/a/a/h$d;
    ...
    new-instance v3, La/n/a/a/h$c;

    invoke-direct {v3}, La/n/a/a/h$c;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, La/n/a/a/h$c;->g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v6, v7, La/n/a/a/h$d;->b:Ljava/util/ArrayList;

    invoke-virtual {v6, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v3}, La/n/a/a/h$f;->getPathName()Ljava/lang/String;

    move-result-object v6

    if-eqz v6, :cond_1

    iget-object v6, v1, La/n/a/a/h$g;->p:La/d/a;
    ...
    new-instance v3, La/n/a/a/h$b;

    invoke-direct {v3}, La/n/a/a/h$b;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, La/n/a/a/h$b;->e(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v7, v7, La/n/a/a/h$d;->b:Ljava/util/ArrayList;
    ...
    iget-object v7, v1, La/n/a/a/h$g;->p:La/d/a;
    ...
    :cond_3
    :goto_1
    iget v7, v0, La/n/a/a/h$h;->a:I

    iget v3, v3, La/n/a/a/h$f;->c:I

    :goto_2
    or-int/2addr v3, v7

    iput v3, v0, La/n/a/a/h$h;->a:I
    ...
    new-instance v3, La/n/a/a/h$d;

    invoke-direct {v3}, La/n/a/a/h$d;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, La/n/a/a/h$d;->c(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {v3}, La/n/a/a/h$d;->getGroupName()Ljava/lang/String;
...
.method private i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {v2, v3}, La/n/a/a/h;->g(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iput-object v2, v0, La/n/a/a/h$h;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, v0, La/n/a/a/h$h;->c:Landroid/content/res/ColorStateList;

    :cond_0
    const/4 v2, 0x5

    iget-boolean v3, v0, La/n/a/a/h$h;->e:Z
    ...
    iput-boolean v2, v0, La/n/a/a/h$h;->e:Z

    const/4 v0, 0x7

    iget v2, v1, La/n/a/a/h$g;->k:F
    ...
    iput v0, v1, La/n/a/a/h$g;->k:F

    const/16 v0, 0x8

    iget v2, v1, La/n/a/a/h$g;->l:F
    ...
    iget v2, v1, La/n/a/a/h$g;->i:F

    invoke-virtual {p1, v0, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v1, La/n/a/a/h$g;->i:F

    const/4 v0, 0x2

    iget v2, v1, La/n/a/a/h$g;->j:F

    invoke-virtual {p1, v0, v2}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v1, La/n/a/a/h$g;->j:F
    ...
    invoke-virtual {v1}, La/n/a/a/h$g;->getAlpha()F
    ...
    invoke-virtual {v1, p2}, La/n/a/a/h$g;->setAlpha(F)V
    ...
    iput-object p1, v1, La/n/a/a/h$g;->n:Ljava/lang/String;

    iget-object p2, v1, La/n/a/a/h$g;->p:La/d/a;
...
.method d(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, La/n/a/a/h$g;->p:La/d/a;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, La/n/a/a/h;->h:[F
    ...
    invoke-direct {p0}, La/n/a/a/h;->f()Z
    ...
    invoke-virtual {v2, v1, v3}, La/n/a/a/h$h;->j(II)V
    ...
    invoke-virtual {v2}, La/n/a/a/h$h;->b()Z
    ...
    invoke-virtual {v1}, La/n/a/a/h$h;->i()V
    ...
    invoke-virtual {v1, p1, v0, v2}, La/n/a/a/h$h;->d(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    new-instance v0, La/n/a/a/h$i;

    iget-object v1, p0, La/n/a/a/g;->b:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object v1

    invoke-direct {v0, v1}, La/n/a/a/h$i;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V
...
.method h(Z)V
    ...
    iput-boolean p1, p0, La/n/a/a/h;->g:Z
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    new-instance v1, La/n/a/a/h$g;

    invoke-direct {v1}, La/n/a/a/h$g;-><init>()V

    iput-object v1, v0, La/n/a/a/h$h;->b:La/n/a/a/h$g;
    ...
    invoke-direct {p0, v1, p2}, La/n/a/a/h;->i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-boolean v1, v0, La/n/a/a/h$h;->k:Z

    invoke-direct {p0, p1, p2, p3, p4}, La/n/a/a/h;->e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V

    iget-object p1, p0, La/n/a/a/h;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object p2, v0, La/n/a/a/h$h;->c:Landroid/content/res/ColorStateList;

    iget-object p3, v0, La/n/a/a/h$h;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, p1, p2, p3}, La/n/a/a/h;->j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public isStateful()Z
    ...
    invoke-virtual {v0}, La/n/a/a/h$h;->g()Z
...
.method j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_0
    invoke-virtual {p0}, La/n/a/a/h;->getState()[I
...
.method protected onStateChange([I)Z
    ...
    invoke-virtual {p0, v0, v2, v4}, La/n/a/a/h;->j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_1
    invoke-virtual {v1}, La/n/a/a/h$h;->g()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1, p1}, La/n/a/a/h$h;->h([I)Z
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, La/n/a/a/h;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object v0, v0, La/n/a/a/h$h;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v1, p1, v0}, La/n/a/a/h;->j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, v1, v0, p1}, La/n/a/a/h;->j(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
