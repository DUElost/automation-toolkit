...
.method public addHyperlink(Ljxl/write/WritableHyperlink;)V
    ...
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getColumn()I

    move-result v0

    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getRow()I
    ...
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->isFile()Z

    move-result v1

    if-nez v1, :cond_3

    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->isUNC()Z
    ...
    :cond_0
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->isURL()Z
    ...
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getURL()Ljava/net/URL;
    ...
    :cond_1
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->isLocation()Z
    ...
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getFile()Ljava/io/File;
    ...
    invoke-virtual {v0}, Ljxl/write/biff/CellValue;->getCellFormat()Ljxl/format/CellFormat;
    ...
    invoke-virtual {v0, v1}, Ljxl/write/biff/CellValue;->setCellFormat(Ljxl/format/CellFormat;)V
    ...
    :goto_3
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getLastRow()I
    ...
    :goto_4
    invoke-virtual {p1}, Ljxl/write/biff/HyperlinkRecord;->getLastColumn()I
...
.method removeDataValidation(Ljxl/write/biff/CellValue;)V
    ...
    invoke-virtual {v0, v1, p1}, Ljxl/biff/DataValidation;->removeDataValidation(II)V
