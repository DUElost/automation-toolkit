...
Deploy-SleepTest -ApkDir $apkDir -TestTimes $TestTimes -WakeSeconds $WakeSeconds `
    -SleepSeconds $SleepSeconds -Tester $Tester -AutoResume:$autoResume -AutoStart:$autoStart
