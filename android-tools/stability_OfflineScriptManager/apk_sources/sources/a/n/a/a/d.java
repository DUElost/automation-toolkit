...
public class d {
    ...
    public static class a implements TypeEvaluator<b.C0005b[]> {
        ...
        public b.C0005b[] evaluate(float f, b.C0005b[] c0005bArr, b.C0005b[] c0005bArr2) {
            if (a.f.e.b.b(c0005bArr, c0005bArr2)) {
                b.C0005b[] c0005bArr3 = this.f341a;
                if (c0005bArr3 == null || !a.f.e.b.b(c0005bArr3, c0005bArr)) {
                    this.f341a = a.f.e.b.f(c0005bArr);
                }
                for (int i = 0; i < c0005bArr.length; i++) {
                    this.f341a[i].d(c0005bArr[i], c0005bArr2[i], f);
                }
                return this.f341a;
            }
    ...
    */
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: a.n.a.a.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        b.C0005b[] d2 = a.f.e.b.d(string);
        b.C0005b[] d3 = a.f.e.b.d(string2);
        if (d2 == null && d3 == null) {
            return null;
        }
        if (d2 == null) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray i = androidx.core.content.c.g.i(resources, theme, attributeSet, a.n.a.a.a.j);
        int i2 = 0;
        TypedValue j = androidx.core.content.c.g.j(i, xmlPullParser, "value", 0);
        if ((j != null) && h(j.type)) {
            i2 = 3;
        }
        i.recycle();
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) {
        TypedArray i = androidx.core.content.c.g.i(resources, theme, attributeSet, a.n.a.a.a.g);
        TypedArray i2 = androidx.core.content.c.g.i(resources, theme, attributeSet, a.n.a.a.a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, i, i2, f, xmlPullParser);
        int f2 = androidx.core.content.c.g.f(i, xmlPullParser, "interpolator", 0, 0);
        if (f2 > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        TypedArray i2 = androidx.core.content.c.g.i(resources, theme, attributeSet, a.n.a.a.a.j);
        float d2 = androidx.core.content.c.g.d(i2, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue j = androidx.core.content.c.g.j(i2, xmlPullParser, "value", 0);
        boolean z = j != null;
        if (i == 4) {
            i = (z && h(j.type)) ? 3 : 0;
        }
        Keyframe ofInt = z ? i != 0 ? (i == 1 || i == 3) ? Keyframe.ofInt(d2, androidx.core.content.c.g.e(i2, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(d2, androidx.core.content.c.g.d(i2, xmlPullParser, "value", 0, 0.0f)) : i == 0 ? Keyframe.ofFloat(d2) : Keyframe.ofInt(d2);
        int f = androidx.core.content.c.g.f(i2, xmlPullParser, "interpolator", 1, 0);
        if (f > 0) {
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray i2 = androidx.core.content.c.g.i(resources, theme, attributeSet, a.n.a.a.a.i);
                String g = androidx.core.content.c.g.g(i2, xmlPullParser, "propertyName", 3);
                int e = androidx.core.content.c.g.e(i2, xmlPullParser, "valueType", 2, 4);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long e = androidx.core.content.c.g.e(typedArray, xmlPullParser, "duration", 1, 300);
        long e2 = androidx.core.content.c.g.e(typedArray, xmlPullParser, "startOffset", 2, 0);
        int e3 = androidx.core.content.c.g.e(typedArray, xmlPullParser, "valueType", 7, 4);
        if (androidx.core.content.c.g.h(xmlPullParser, "valueFrom") && androidx.core.content.c.g.h(xmlPullParser, "valueTo")) {
            if (e3 == 4) {
                e3 = f(typedArray, 5, 6);
            }
            PropertyValuesHolder e4 = e(typedArray, e3, 5, 6, BuildConfig.FLAVOR);
            if (e4 != null) {
        ...
        valueAnimator.setRepeatCount(androidx.core.content.c.g.e(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(androidx.core.content.c.g.e(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        String g = androidx.core.content.c.g.g(typedArray, xmlPullParser, "pathData", 1);
        if (g == null) {
            objectAnimator.setPropertyName(androidx.core.content.c.g.g(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String g2 = androidx.core.content.c.g.g(typedArray, xmlPullParser, "propertyXName", 2);
        String g3 = androidx.core.content.c.g.g(typedArray, xmlPullParser, "propertyYName", 3);
        if (i != 2) {
        }
        if (g2 != null || g3 != null) {
            s(a.f.e.b.e(g), objectAnimator, f * 0.5f, g2, g3);
            return;
        }
