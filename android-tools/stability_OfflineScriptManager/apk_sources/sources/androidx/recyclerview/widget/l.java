...
public abstract class l extends RecyclerView.l {
    ...
    public boolean a(RecyclerView.c0 c0Var, RecyclerView.l.c cVar, RecyclerView.l.c cVar2) {
        int i;
        int i2;
        return (cVar == null || ((i = cVar.f1135a) == (i2 = cVar2.f1135a) && cVar.f1136b == cVar2.f1136b)) ? w(c0Var) : y(c0Var, i, cVar.f1136b, i2, cVar2.f1136b);
    }
    ...
    public boolean d(RecyclerView.c0 c0Var, RecyclerView.l.c cVar, RecyclerView.l.c cVar2) {
        ...
        return y(c0Var, i, cVar.f1136b, i2, cVar2.f1136b);
    }
