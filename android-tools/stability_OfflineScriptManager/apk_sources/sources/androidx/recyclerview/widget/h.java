...
public class h {
    ...
    private void c(List<a.b> list, int i, a.b bVar, int i2, a.b bVar2) {
        ...
        if (i4 <= i6) {
            bVar.f1189b = i6 + bVar2.f1191d;
        }
        int i7 = bVar2.f1189b;
        if (i7 <= i3) {
            bVar.f1191d = i3 + bVar2.f1191d;
        }
        bVar2.f1189b = i7 + i5;
        list.set(i, bVar2);
        list.set(i2, bVar);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:45:0x009e, code lost:
        if (r0 > r14.f1189b) goto L38;
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x00c8, code lost:
        if (r0 >= r14.f1189b) goto L38;
     */
    /* JADX WARN: Code restructure failed: missing block: B:59:0x00ca, code lost:
        r12.f1191d = r0 - r14.f1191d;
     */
    /*
    ...
    */
    void f(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        Ld:
            ...
            int r5 = r5 - r4
            r13.f1191d = r5
            androidx.recyclerview.widget.h$a r0 = r8.f1259a
            int r1 = r11.f1189b
            java.lang.Object r5 = r13.f1190c
        ...
        L2b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.h$a r3 = r8.f1259a
            int r1 = r1 + r4
            java.lang.Object r4 = r13.f1190c
        ...
        L4c:
            r9.remove(r10)
            androidx.recyclerview.widget.h$a r11 = r8.f1259a
            r11.a(r13)
        L54:
            if (r0 == 0) goto L59
            r9.add(r10, r0)
