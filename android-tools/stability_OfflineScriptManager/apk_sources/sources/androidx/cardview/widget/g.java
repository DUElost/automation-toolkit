...
class g extends Drawable {
    ...
    private Paint f810b = new Paint(5);
    ...
    public g(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        ...
        this.f809a = resources.getDimensionPixelSize(a.c.c.cardview_compat_inset_shadow);
        n(colorStateList);
        ...
        this.f = (int) (f + 0.5f);
        this.e = new RectF();
        Paint paint2 = new Paint(this.f811c);
        this.f812d = paint2;
    ...
    private void e(Canvas canvas) {
        float f = this.f;
        float f2 = (-f) - this.i;
        float f3 = f + this.f809a + (this.j / 2.0f);
        float f4 = f3 * 2.0f;
        ...
        canvas.drawPath(this.g, this.f811c);
        if (z) {
            canvas.drawRect(0.0f, f2, this.e.width() - f4, -this.f, this.f812d);
        }
        ...
        canvas.drawPath(this.g, this.f811c);
        if (z) {
            canvas.drawRect(0.0f, f2, this.e.width() - f4, (-this.f) + this.i, this.f812d);
        }
        ...
        canvas.drawPath(this.g, this.f811c);
        if (z2) {
            canvas.drawRect(0.0f, f2, this.e.height() - f4, -this.f, this.f812d);
        }
    ...
    private void n(ColorStateList colorStateList) {
        ...
        this.f810b.setColor(colorStateList.getColorForState(getState(), this.k.getDefaultColor()));
    }
    ...
    private void s(float f, float f2) {
        if (f < 0.0f) {
            ...
            this.j = t;
            this.h = t2;
            this.i = (int) ((t * 1.5f) + this.f809a + 0.5f);
            this.l = true;
            invalidateSelf();
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        e(canvas);
        canvas.translate(0.0f, (-this.j) / 2.0f);
        r.a(canvas, this.e, this.f, this.f810b);
    }
    ...
    public float j() {
        float f = this.h;
        return (Math.max(f, this.f + this.f809a + ((f * 1.5f) / 2.0f)) * 2.0f) + (((this.h * 1.5f) + this.f809a) * 2.0f);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float k() {
        float f = this.h;
        return (Math.max(f, this.f + this.f809a + (f / 2.0f)) * 2.0f) + ((this.h + this.f809a) * 2.0f);
    }
    ...
    protected boolean onStateChange(int[] iArr) {
        ...
        if (this.f810b.getColor() == colorForState) {
            return false;
        }
        this.f810b.setColor(colorForState);
        this.l = true;
        invalidateSelf();
        return true;
    }
    ...
    public void setAlpha(int i) {
        this.f810b.setAlpha(i);
        this.f811c.setAlpha(i);
        this.f812d.setAlpha(i);
    }

    @Override // android.graphics.drawable.Drawable
    public void setColorFilter(ColorFilter colorFilter) {
        this.f810b.setColorFilter(colorFilter);
    }
}
