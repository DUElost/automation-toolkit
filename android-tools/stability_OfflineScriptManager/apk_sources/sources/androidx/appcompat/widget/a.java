...
public abstract class a extends ViewGroup {
    ...
    protected final C0027a f649b;

    /* renamed from: c  reason: collision with root package name */
    protected final Context f650c;

    /* renamed from: d  reason: collision with root package name */
    protected ActionMenuView f651d;
    ...
    /* loaded from: classes.dex */
    protected class C0027a implements a.f.l.w {
        ...
        public void a(View view) {
            ...
            a aVar = a.this;
            aVar.g = null;
            a.super.setVisibility(this.f653b);
        }
        ...
        public C0027a d(a.f.l.v vVar, int i) {
            a.this.g = vVar;
            this.f653b = i;
            return this;
        }
    ...
    public a.f.l.v f(int i, long j) {
        a.f.l.v vVar = this.g;
        if (vVar != null) {
            vVar.b();
        }
        if (i != 0) {
            a.f.l.v a2 = a.f.l.r.a(this);
            a2.a(0.0f);
            a2.d(j);
            C0027a c0027a = this.f649b;
            c0027a.d(a2, i);
            a2.f(c0027a);
            return a2;
        }
        ...
        a.f.l.v a3 = a.f.l.r.a(this);
        a3.a(1.0f);
        a3.d(j);
        C0027a c0027a2 = this.f649b;
        c0027a2.d(a3, i);
        a3.f(c0027a2);
        return a3;
    }
    ...
    public int getAnimatedVisibility() {
        return this.g != null ? this.f649b.f653b : getVisibility();
    }
