...
class p {
    ...
    private static final int[] f745c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f746a;
    ...
    public void c(AttributeSet attributeSet, int i) {
        q0 t = q0.t(this.f746a.getContext(), attributeSet, f745c, i, 0);
        Drawable g = t.g(0);
        if (g != null) {
            this.f746a.setIndeterminateDrawable(e(g));
        }
        Drawable g2 = t.g(1);
        if (g2 != null) {
            this.f746a.setProgressDrawable(d(g2, false));
        }
        t.u();
    }
}
