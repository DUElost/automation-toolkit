...
public class d0 extends ViewGroup {
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            this.f676a = obtainStyledAttributes.getFloat(a.a.j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f677b = obtainStyledAttributes.getInt(a.a.j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public d0(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f675d = 0;
        this.f = 8388659;
        q0 t = q0.t(context, attributeSet, a.a.j.LinearLayoutCompat, i, 0);
        int j = t.j(a.a.j.LinearLayoutCompat_android_orientation, -1);
        if (j >= 0) {
            setOrientation(j);
        }
        int j2 = t.j(a.a.j.LinearLayoutCompat_android_gravity, -1);
        if (j2 >= 0) {
            setGravity(j2);
        }
        boolean a2 = t.a(a.a.j.LinearLayoutCompat_android_baselineAligned, true);
        if (!a2) {
            setBaselineAligned(a2);
        }
        this.h = t.h(a.a.j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f674c = t.j(a.a.j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.i = t.a(a.a.j.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(t.f(a.a.j.LinearLayoutCompat_divider));
        this.o = t.j(a.a.j.LinearLayoutCompat_showDividers, 0);
        this.p = t.e(a.a.j.LinearLayoutCompat_dividerPadding, 0);
        t.u();
    }
    ...
    */
    void v(int r18, int r19, int r20, int r21) {
        ...
        L59:
            ...
            r1 = r11
        L75:
            int r2 = a.f.l.r.q(r17)
            int r1 = a.f.l.c.b(r1, r2)
            r1 = r1 & 7
            if (r1 == r14) goto L8b
            r2 = 5
            if (r1 == r2) goto L88
