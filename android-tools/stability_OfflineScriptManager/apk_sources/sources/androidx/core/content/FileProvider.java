...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f854c = {"_display_name", "_size"};

    /* renamed from: d  reason: collision with root package name */
    private static final File f855d = new File("/");
    ...
    public static class b implements a {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final HashMap<String, File> f858b = new HashMap<>();
        ...
        public File a(Uri uri) {
            ...
            File file = this.f858b.get(decode);
            if (file == null) {
        ...
        public Uri b(File file) {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f858b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f857a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
            } catch (IOException unused) {
        ...
        void c(String str, File file) {
            ...
            try {
                this.f858b.put(str, file.getCanonicalFile());
            } catch (IOException e) {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f856b = d(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f856b.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File a2 = this.f856b.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.f856b.a(uri), f(str));
    }
