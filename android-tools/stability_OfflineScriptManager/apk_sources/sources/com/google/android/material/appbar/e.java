...
class e {
    ...
    private static final int[] f2289a = {16843848};
    ...
    public static void b(View view, float f) {
        ...
        long j = integer;
        stateListAnimator.addState(new int[]{16842766, b.d.a.a.b.state_liftable, -b.d.a.a.b.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(j));
    ...
    public static void c(View view, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray h = f.h(context, attributeSet, f2289a, i, i2, new int[0]);
        try {
            if (h.hasValue(0)) {
