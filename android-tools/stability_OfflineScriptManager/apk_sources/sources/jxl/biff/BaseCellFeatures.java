...
public class BaseCellFeatures {
    ...
    public BaseCellFeatures(BaseCellFeatures baseCellFeatures) {
        ...
        if (baseCellFeatures.dvParser != null) {
            this.dvParser = new DVParser(baseCellFeatures.dvParser);
        }
    }
    ...
    public void setNumberValidation(double d2, double d3, ValidationCondition validationCondition) {
        clearValidationSettings();
        this.dvParser = new DVParser(d2, d3, validationCondition.getCondition());
        this.dropDown = false;
        this.dataValidation = true;
    }
    ...
    public void setNumberValidation(double d2, ValidationCondition validationCondition) {
        clearValidationSettings();
        this.dvParser = new DVParser(d2, Double.NaN, validationCondition.getCondition());
        this.dropDown = false;
        this.dataValidation = true;
    }
