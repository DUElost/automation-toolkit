...
public class SheetRangeImpl implements Range {
    ...
    public Cell getBottomRight() {
        return (this.column2 >= this.sheet.getColumns() || this.row2 >= this.sheet.getRows()) ? new EmptyCell(this.column2, this.row2) : this.sheet.getCell(this.column2, this.row2);
    }
    ...
    public Cell getTopLeft() {
        return (this.column1 >= this.sheet.getColumns() || this.row1 >= this.sheet.getRows()) ? new EmptyCell(this.column1, this.row1) : this.sheet.getCell(this.column1, this.row1);
    }
