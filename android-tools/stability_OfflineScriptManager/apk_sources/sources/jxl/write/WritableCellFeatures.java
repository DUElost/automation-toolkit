...
public class WritableCellFeatures extends CellFeatures {
    ...
    @Override // jxl.biff.BaseCellFeatures
    public void setNumberValidation(double d2, double d3, BaseCellFeatures.ValidationCondition validationCondition) {
        super.setNumberValidation(d2, d3, validationCondition);
    }

    @Override // jxl.biff.BaseCellFeatures
    public void setNumberValidation(double d2, BaseCellFeatures.ValidationCondition validationCondition) {
        super.setNumberValidation(d2, validationCondition);
    }
}
